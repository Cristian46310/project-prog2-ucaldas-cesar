...
// Method to save meal information from CSV file
    ...
    // Method to add new meals
        ...
        while(timeOfDay==null){    
            //obtain information about the meals, if it is the afternoon or morning, id, name, calories, and macronutrients
       Console.writeLine("Ingrese el tiempo en el que se hara la comida: 1)Desayuno, 2) almuerzo, 3)comida, 4)M. mañana, 5)Algo.");
    ...
    public void addDiets(){
        ...
        if(getDietPlan(planId)!= null){
            Console.writeLine("El id del plan de comida ya esta siendo utilizado por otro, por favor ingresar otro id.");            
        }
        }
        ...
        DietPlan dietPla=new DietPlan(planId,newDailyCalories,newMacronutrients,newSpecificRecommendations,dietitianid,patientId);
